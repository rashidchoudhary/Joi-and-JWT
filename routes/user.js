...
import schema from "../validations/user.validate.js";
...
router.get("/:id",authenticate,validate(schema.id.params),async (req, res) => {
		try {
...
router.delete("/:id",authenticate,validate(schema.id.params),async (req, res) => {
		try {
